...
4. 快速索引技巧
   ...
   目录下面有 "分支", "标签" 等二级目录, 横向归类相关的 git 操作. 但是有些操作是贯穿了多个二级目录, 所以使用 tag 的方式进行纵向归类.

   常见的索引 tag 有:

   + 某文件: git 中对某个文件的操作, 简称为 "某文件".

5. 如果喜欢这个项目，欢迎 Star、提交 Pr、[反馈问题](https://github.com/521xueweihan/git-tips/issues)😊
...
* [从 stash 中拿出某文件的修改](#从-stash-中拿出某文件的修改)
